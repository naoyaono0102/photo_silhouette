...
//                                // まだ何も選択していない場合 → タップで CompressionSettingView へ
...
////                                            isSelected: false,
////                                            onToggle: {
////                                                print("チェックボタンのON・OFFを変更します")
////                                                // チェックボタンが押されたら選択状態にする
...
//                            .onEnded { _ in isSelecting = true }
//                    )
//                    .simultaneousGesture(
//                        DragGesture(minimumDistance: 0)
//                            .onChanged { value in
//                                guard isSelecting else { return }
//                                // value.location は "gallery" の座標
